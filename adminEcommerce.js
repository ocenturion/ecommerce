            ...
            if (tipoDeConsulta=='abmProductos') {
                ...
                respuesta2.forEach(element => {
                    ...
                    <tr>
                        ...
                        <td>
                            <button class="btn btn-secondary" data-toggle="modal" data-target="#modalModificar" onclick="onclick_btnEditar('Producto','${element.id}','${element.nombre}','${element.precio}','${element.descripcion}','','','${element.id_categoria}','${element.id_proveedor}')">
